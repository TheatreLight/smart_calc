...
void MainWindow::on_pushButton_21_clicked() { ui->lineEdit->insert(" mod "); }
...
void MainWindow::on_pushButton_30_clicked() {
  if (is_brscket_open) {
    ui->lineEdit->insert(" ) ");
    bracket_count--;
    if (bracket_count <= 0) is_brscket_open = false;
  }
}

void MainWindow::on_pushButton_23_clicked() { ui->lineEdit->insert(" + "); }

void MainWindow::on_pushButton_24_clicked() { ui->lineEdit->insert(" - "); }

void MainWindow::on_pushButton_25_clicked() { ui->lineEdit->insert(" * "); }

void MainWindow::on_pushButton_26_clicked() { ui->lineEdit->insert(" / "); }

void MainWindow::on_pushButton_22_clicked() { ui->lineEdit->insert(" ^ "); }
...
void MainWindow::on_pushButton_27_clicked() {
  ...
  if (x_str != "\0") var_x = x_str.toDouble();
...
void MainWindow::on_radioButton_toggled(bool checked) { isAnnuity = checked; }
