...
set_target_properties(Qt6::WaylandClient PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libQt6WaylandClient.so.6.2.4"
  IMPORTED_SONAME_RELWITHDEBINFO "libQt6WaylandClient.so.6"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qt6::WaylandClient )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::WaylandClient "${_IMPORT_PREFIX}/lib/libQt6WaylandClient.so.6.2.4" )
