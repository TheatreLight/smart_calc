...
set_target_properties(Qt6::LabsSharedImage PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libQt6LabsSharedImage.so.6.2.4"
  IMPORTED_SONAME_RELWITHDEBINFO "libQt6LabsSharedImage.so.6"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qt6::LabsSharedImage )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::LabsSharedImage "${_IMPORT_PREFIX}/lib/libQt6LabsSharedImage.so.6.2.4" )
