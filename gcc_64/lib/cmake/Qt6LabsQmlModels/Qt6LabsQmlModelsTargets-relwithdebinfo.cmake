...
set_target_properties(Qt6::LabsQmlModels PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libQt6LabsQmlModels.so.6.2.4"
  IMPORTED_SONAME_RELWITHDEBINFO "libQt6LabsQmlModels.so.6"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qt6::LabsQmlModels )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::LabsQmlModels "${_IMPORT_PREFIX}/lib/libQt6LabsQmlModels.so.6.2.4" )
